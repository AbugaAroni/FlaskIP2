...
class NewsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_News = News(1234,'Title of the story','BBC','Brexit happened because zyz',"https://ichef.bbci.co.uk/images/ic/1024x576/p08rdfbt.jpg"
...
,)
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_News.title,"Title of the story")
        self.assertEqual(self.new_News.broadcaster,"BBC")
        ...
        self.assertEqual(self.new_News.URLsource,"https://www.cnn.com/2020/09/14/politics/election-2020-ballot-signature-mismatches/index.html")
